#!/usr/bin/env python3
# 👆 Specifying the required python config for macOS systems.
# will need to be modified according to System that it is to be running on
...
def analyze_packet(pkt, idx, counter):
    ...
    # --- Checking for Protocol Type and related extractable data ---
    #  For DNS query
